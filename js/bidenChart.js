...
const candidate = "Biden";
const lineColor = "#244DC7";
const annotations = [
    { Date: new Date("2024-01-05"), Score: 42.37, Label: "Jan 5: First campaign rally of the year", LineOffset: 60, TextOffset: 5, Align: "start" },
